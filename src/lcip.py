...
"""
p1 = Point2(-140.38800507462761402, -54.16228782222089677)
p11 = Point2(-140.33848472480769942, -54.09569148970446406)
p10 = Point2(-140.39312786943656874, -54.0393407468059479)
p9 = Point2(-140.34360751961665414, -54.02738755891838451)
p8 = Point2(-140.30774795595397109, -54.06495472085072862)
p7 = Point2(-140.20016926496589349, -54.05812432777211995)
p6 = Point2(-140.16089450476388834, -54.12130546374925189)
p5 = Point2(-140.10795895840468006, -54.08715349835620856)
p4 = Point2(-140.07039179647230753, -54.10252188278307273)
p3 = Point2(-140.13698812898874735, -54.15033463433333338)
p2 = Point2(-140.07039179647233595, -54.18960939453533143)
...
for v in he:
    if v.source().point() == p11 and v.target().point() == p1:
        edge = v
        break

ts = TriangularExpansionVisibility(arr)
tx = ts.compute_visibility(query_point, edge)

points = []

for v in tx.vertices:
    print('%.17f' % v.point().x(), '%.17f' % v.point().y())
    points += [Point2(v.point().x(), v.point().y())]
...
while i < n :
    conc += [Segment2(points[i], points[i+1])]
    i += 1

conc += [Segment2(points[n], points[0])]
...
for v in he:
    if v.source().point() == p1 and v.target().point() == p2:
        edge = v
        break
...
"""
    ...
    python /home/user/concavities/src/lcip.py 'LineString (-0.75283631820074914 0.70959600166597325, 2.35466888796335061 0.64708871303623572)' 'LineString (-0.73497709287796686 1.13821740941274596, 0.28299875052061729 1.63827571845064712, 0.5062390670553949 1.29002082465639445, 0.24728029987505318 1.25430237401082989, 0.24728029987505318 1.42396501457726066, -0.0027488546438974 1.29002082465639445, 0.29192836318200843 1.04892128279883501, 0.72054977092878092 1.07571012078300843, 0.63125364431486997 1.45075385256143408, 0.20263223656809748 1.83472719700125109, 0.90807163681799397 1.71864223240316694, 0.88128279883382055 1.34359850062474084, 1.25632653061224664 1.1024989587671814, 2.05999167013744477 1.3793169512703054)' '0' '100' '0' 
...
def get_seg_to_concavity_msegs_opt2(seg, line):
    ...
    return msegs, _n_segs, (t_1 - t_0), _n_concavities
...
if TESTING:
    ...
    print('Seg >> Concavity : N Tests: ' + str(NTESTS))
